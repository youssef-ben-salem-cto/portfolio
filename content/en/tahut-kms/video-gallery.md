...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/auth/login-web-authn.mov" type="video/mp4">
    </video>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/auth/sso-auth0-login.mp4" type="video/mp4">
    </video>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/auth/bulk-user.mp4" type="video/mp4">
    </video>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/auth/accept-invitation.mp4" type="video/mp4">
    </video>
  </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/collection/create-collection.mov" type="video/mp4">
    </video>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/collection/ingestion.mp4" type="video/mp4">
    </video>
  </div>
...
<div class="grid grid-cols-1 gap-8 mt-6 max-w-4xl mx-auto">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/workspace/chat.mp4" type="video/mp4">
    </video>
  </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/settings/add-models.mp4" type="video/mp4">
    </video>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col h-full">
    ...
    <video controls preload="metadata" class="w-full h-auto rounded-lg bg-black mt-auto">
      <source src="/images/tahut-kms/videos/settings/maintenance.mp4" type="video/mp4">
    </video>
  </div>
